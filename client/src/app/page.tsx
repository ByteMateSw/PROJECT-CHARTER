  ...
  return (
    <>
      ...
      <main className="min-h-screen w-full flex-col items-center justify-center gap-10 inline-flex">
        ...
        <section className=" h-[350px] w-[1000px] flex-col flex justify-start items-start pt-24">
          ...
          <h1 className="text-secondary-black text-[40px] font-extrabold">
            Encuentra talentos</h1>
          <h1 className="text-secondary-black  text-[40px] font-extrabold">
            Contrata habilidades </h1>
          <span className="text-primary-blue text-[40px] font-extrabold">
            Conéctate </span><span className="text-secondary-black text-[40px] font-extrabold"> con los mejores</span></div>
          <div className="flex items-center justify-between gap-5 px-20 pt-4">
            <button className="rounded-2x1 w-40 h-8 font-semibold bg-secondary-gray">numero1</button>
      ...
      <section className="w-[2500px] h-[450px] flex items-center justify-center flex-col " >
        ...
        <h1 className="text-center h-[150px] px-4 py-10 text-secondary-black text-xl font-extrabold">Mira algunos perfiles</h1>
            ...
            return (
              <figure className="h-[140px] w-[140px]" key={profile.name}>
                <img
                  ...
                  alt={profile.name}
                  className="h-[140px] w-[140px] rounded-full text-[#97989B]"
                  />
        ...
        <h1 className="text-secondary-black text-[30px] font-extrabold">Potencia tu perfil</h1>
        <div className=" h-[250px] w-[1000px] flex-col content-center gap-6 flex justify-start items-start">
          <h3 className="text-secondary-black text-x1 font-semibold text-start">
            Completa tu perfil profesional con tu experiencia laboral, habilidades y educación</h3>
          <h3 className="text-secondary-black text-x1 font-semibold text-start">
            Muestra tus proyectos más relevantes y logros profesionales</h3>
          <h3 className="text-secondary-black text-x1 font-semibold text-start">
            Establece tu ubicación, tus horarios y días disponible</h3>
          <h3 className="text-secondary-black text-x1 font-semibold text-start">
            Recibe reseñas de clientes</h3>
        </div>
