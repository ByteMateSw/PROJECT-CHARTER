export default function page() {
   return (
    <main className="min-h-screen flex justify-center items-center flex-col">
      <section className=" shadow-lg w-80 h-80 items-center flex-col border-2 border-gray-900/5 flex bg-white px-6 py-8 rounded-lg">
      <h1 className="font-bold text-base ">Registro Ciudad</h1>
      <div className=" w-60 ">
        <article>
          <label className=" mt-3 my-1 mb-2 block"> Ciudad  </label> 
          <div>
          <input className="w-60 h-10 mt-1 mb-5 border-2 border-stone-200 bg-white text-slate-500" type= "text" id="ciudad"
        ...
        <article className="flex items-center">
          ...
          <div>
          <select className=" rounded-md border-2 shadow-lg border-gray-200 focus:ring-2 bg-transparent placeholder: elija la opcion">
