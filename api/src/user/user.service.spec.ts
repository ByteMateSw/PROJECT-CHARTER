...
describe("UserService", () => {
    ...
    describe("createUser", () => {
        ...
        it("should throw an error for repeated email", async () => {
            ...
            expect(async () => await service.createUser(mockUser))
                .rejects.toThrow(new Error("El Email está en uso"))
        })
    })
    ...
    describe("hasEmail", () => {
        ...
        it("should throw an error to obtain an email", async () => {
            ...
            expect(async () => await service.hasEmail(rejectedEmail))
                .rejects.toThrow(new Error("No se ha encontrado el Email"))
        })
    })
    ...
    describe("deleteUser", () => {
        ...
        it("should throw an error for nonexistent user", async () => {
            ...
            expect(async () => await service.deleteUser(id))
    ...
    describe("updateUser", () => {
        ...
        it("should throw an error for nonexistent user", async () => {
            ...
            expect(async () => await service.updateUser(id, mockUser))
                .rejects.toThrow(new Error("El usuario no existe"))
        })
    })
